...
void comparator(
  int image[286][372],
   ...
   uint8_t *norm_LH,
   uint8_t *norm_LL
   ){_ssdm_SpecArrayDimSize(image, 286);
  ...
  *norm_LH = edge_map_single_value(LH_val,255.0f,30.0f);
  *norm_HL = edge_map_single_value(HL_val,255.0f,30.0f);
  *norm_HH = edge_map_single_value(HH_val,255.0f,30.0f);
