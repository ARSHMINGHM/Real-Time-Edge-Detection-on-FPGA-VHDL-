...
// ==============================================================
#ifndef __SaveToRamAndOutpubkb__HH__
#define __SaveToRamAndOutpubkb__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(SaveToRamAndOutpubkb) {
    ...
    SC_CTOR(SaveToRamAndOutpubkb):  simcore_mac_0_U ("simcore_mac_0_U") {
